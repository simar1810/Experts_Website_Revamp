            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    {[...categories, ...categories].map((cat, index) => (
                        <div key={index} className="flex-shrink-0 w-56 sm:w-64 bg-gray-900 p-5 rounded-2xl border border-gray-800 hover:border-lime-500 transition-all cursor-pointer group snap-start">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-800 rounded-xl mb-4 group-hover:bg-lime-500/20 transition-colors"></div>
                            <h3 className="font-bold text-gray-200 group-hover:text-lime-500 transition-colors text-sm sm:text-base leading-tight">{cat}</h3>
                        </div>
                    ))}
                </div>
