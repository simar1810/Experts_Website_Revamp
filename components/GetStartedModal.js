...
export default function GetStartedModal({ isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
            ...
            {/* Modal Container */}
            <div
                className="relative w-full max-w-[520px] animate-in fade-in zoom-in duration-300 outline-none z-10"
            >
                {/* Card */}
                <div
                    className="bg-white rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 relative shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-2 border-[#71BC2B]"
                >
                    {/* Close button */}
                    <button
                        onClick={onClose}
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center px-1">
                                            ...
                                            {touched && errors.name && <span className="text-[10px] sm:text-xs font-bold text-red-500 animate-in fade-in slide-in-from-right-1 tracking-tight">(required)</span>}
                                        </div>
                                        <input
                                            type="text"
                                            value={name}
                                            onChange={(e) => {
                                                ...
                                                if (touched && e.target.value) setErrors(prev => ({ ...prev, name: false }));
                                            }}
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center px-1">
                                            ...
                                            {touched && errors.phone && <span className="text-[10px] sm:text-xs font-bold text-red-500 animate-in fade-in slide-in-from-right-1 tracking-tight">(required)</span>}
                                        </div>
                                        <input
                                            type="text"
                                            value={phone}
                                            onChange={(e) => {
                                                ...
                                                if (touched && e.target.value) setErrors(prev => ({ ...prev, phone: false }));
                                            }}
                                            placeholder="Write here..."
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-center px-1">
                                                ...
                                                {touched && errors.city && <span className="text-[10px] sm:text-xs font-bold text-red-500 animate-in fade-in slide-in-from-right-1 tracking-tight">(req)</span>}
                                            </div>
                                            <input
                                                type="text"
                                                value={city}
                                                onChange={(e) => {
                                                    ...
                                                    if (touched && e.target.value) setErrors(prev => ({ ...prev, city: false }));
                                                }}
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-center px-1">
                                                ...
                                                {touched && errors.state && <span className="text-[10px] sm:text-xs font-bold text-red-500 animate-in fade-in slide-in-from-right-1 tracking-tight">(req)</span>}
                                            </div>
                                            <input
                                                type="text"
                                                value={state}
                                                onChange={(e) => {
                                                    ...
                                                    if (touched && e.target.value) setErrors(prev => ({ ...prev, state: false }));
                                                }}
