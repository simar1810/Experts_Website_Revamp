...
export default function Navbar({ loggedIn = false, userName = "Simarpreet Singh" }) {
                ...
                <div className="flex items-center gap-1.5 sm:gap-4 md:justify-end">
                    {loggedIn ? (
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-3">
                            ...
                            <button className="hidden sm:block text-[#84cc16] px-6 sm:px-8 py-2 sm:py-2.5 rounded-xl font-bold hover:bg-gray-50 transition-colors border-2 border-[#84cc16] text-sm whitespace-nowrap">
                                Log In
                            </button>
                        </div>
                    )
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-white border-t border-gray-100">
                    <div className="flex flex-col p-4 space-y-2">
                        ...
                        {!loggedIn && (
                            <button className="w-full text-left px-4 py-3 rounded-lg text-sm text-[#84cc16] font-bold hover:bg-gray-50 border-t border-gray-50 mt-2">
                                Log In
                            </button>
                        )}
                    </div>
