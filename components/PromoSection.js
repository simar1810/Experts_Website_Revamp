        ...
        <section className="relative py-16 px-6 overflow-hidden bg-white">
            ...
            <div className="absolute inset-0 z-0 opacity-[0.12]">
                <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="mesh-grid" width="120" height="120" patternUnits="userSpaceOnUse">
                            <path d="M 0 60 Q 30 0 60 60 T 120 60" fill="none" stroke="#2D5A11" strokeWidth="0.8" />
                            <path d="M 60 0 Q 0 30 60 60 T 60 120" fill="none" stroke="#2D5A11" strokeWidth="0.8" />
                        </pattern>
                    </defs>
                    <rect width="100%" height="100%" fill="url(#mesh-grid)" className="transform scale-[2.5] rotate-[15deg] origin-center" />
                </svg>
            </div>
                ...
                <div className="grid lg:grid-cols-2 p-8 md:p-14 md:items-center">
                    ...
                    <div className="max-w-2xl mb-12 lg:mb-0 text-center lg:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4 pt-4">
                            <button className="bg-[#84CC16] hover:bg-[#a3e635] text-white px-6 py-3 rounded-[15px] sm:rounded-[20px] font-black text-base sm:text-lg transition-all flex items-center justify-center gap-3 shadow-2xl shadow-black/30 hover:-translate-y-1 active:scale-95">
                                Become a Expert <span className="text-xl sm:text-2xl">→</span>
                            </button>
                            <button className="bg-white hover:bg-gray-50 text-[#3F6212] px-6 py-3 rounded-[15px] sm:rounded-[20px] font-black text-base sm:text-lg transition-all shadow-2xl shadow-black/10 hover:-translate-y-1 active:scale-95">
                                Explore Pricing
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 items-start lg:translate-x-8">
                        <div className="space-y-4 sm:space-y-6">
                            ...
                            <div className="bg-white/20 backdrop-blur-2xl p-5 rounded-2xl border border-white/30 shadow-2xl transform lg:hover:rotate-2 transition-all duration-700">
                                ...
                                <h4 className="text-white font-black text-lg mb-2 leading-tight">Expert Networking</h4>
                            ...
                            <div className="bg-black/30 backdrop-blur-2xl p-5 rounded-2xl border border-white/10 shadow-2xl transform lg:hover:-rotate-2 transition-all duration-700">
                                ...
                                <h4 className="text-white font-black text-lg mb-2 leading-tight">Growth Tools</h4>
                                <p className="text-white/80 text-[10px] leading-relaxed font-bold tracking-wide uppercase opacity-90">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                </p>
                            </div>
                        ...
                        <div className="space-y-4 sm:space-y-6 sm:mt-12">
                            ...
                            <div className="bg-white p-5 rounded-2xl shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)] transform lg:hover:-rotate-3 transition-all duration-700">
                                ...
                                <h4 className="text-[#1a340a] font-black text-lg mb-2 leading-tight">Seamless Payments</h4>
