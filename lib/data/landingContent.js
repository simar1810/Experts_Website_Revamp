...
export const testimonials = [
  {
    ...
    content:
      "Zeefit's impressive expertise in bodybuilding and healthy living is truly remarkable. From the moment I joined the platform years ago, the expert guidance caught my attention. Conversations about training and nutrition revealed calm and supportive coaching. Zeefit's vast knowledge and guidance can help anyone achieve their desired body goals. As a member, I'm grateful for the invaluable support whenever I need it. It is truly a blessing!",
  },
  {
    id: 2,
    name: "KUNAL SANTWANI",
    ...
    content:
      "Zeefit has been instrumental in helping me reach my dream body transformation goal for a show back in 2019. Ever since then, it has been my go-to fitness platform for maintaining my fitness and keeping me in shape throughout the year. With expert guidance and coaching on Zeefit, I am able to trust the platform blindly for all my fitness needs for any upcoming shows or projects. It's been 4 years now and it has delivered the best results every time.",
  },
  {
    id: 3,
    ...
    content:
      "I'm so grateful that I found Zeefit as my first-ever fitness platform, it taught me how to balance my fitness goals with my personal and professional life. Thanks to the guidance I received, fitness is now an integral part of my life, even with my busy work schedule. I'm thankful for the strong foundation that was laid, making it easy for me to maintain my healthy habits for over 3 years now.",
  },
  {
    id: 4,
    name: "NADEEM AHMED",
    ...
    content:
      "In this fast-paced world of Film and Television industry, staying fit can be a challenge. Thanks to Zeefit's expert guidance, I've prioritized my health and well-being. The simple yet effective solutions have kept me in shape, despite my unpredictable schedule. After achieving initial success, I set a goal to transform my physique in just 30 days for an event and Zeefit delivered incredible results. Zeefit is not only skilled but also compassionate, pushing you beyond your limits.",
  },
  {
    id: 5,
    name: "NADEESH BHAMBI",
    ...
    content:
      "I used to have a terrible appetite and was unhealthily skinny. A hectic work schedule didn't help either. With Zeefit's help, I was able to stick to a workout routine customised to my schedule and a diet I could follow without difficulty. With sustained efforts I'm now the healthiest I've been and confident in my own skin.",
  },
  {
    id: 6,
    name: "IKROOP NIJJAR",
    ...
    content:
      "I started training with Zeefit at the back of the pandemic with a specific goal in mind: To be fit to cover a 100km Everest Base Camp trek. I found the approach methodical, customized to my individual needs and rooted in science. My coach was patient and made working out enjoyable. Zeefit guided me in making better food choices and made working out a lifestyle choice. Thanks to Zeefit's training and nutrition guidance, completing my trek was a breeze. I could truly feel the benefits of expert support throughout the journey.",
  },
  {
    id: 7,
    ...
    content:
      "I have been at my best since I started training with Zeefit. Not only am I healthier and fitter, but important lifestyle patterns that I was struggling with for a long time also changed for good. Zeefit has an eye for detail and always ensures that the body posture and technique are apt while strength training. The best part? There is no need to endure hunger pangs or food cravings! A well-balanced diet coupled with the best workout regime is a forte on the platform. It is definitely the best lifestyle coaching experience I have come across.",
  },
  {
    id: 8,
    name: "DEVANSHU DUBEY",
    ...
    content:
      "I have been taking personal training for the past five years now. With Zeefit it's my fourth month—the amount of punctuality, professionalism, and sincerity my coach has shown, I have not seen it anywhere else yet. The experts have immense knowledge about the workouts and their effects. Sessions are always well prepared with full dedication. I have started looking forward to every session.",
  },
  {
    id: 9,
    name: "DHWANI THAKER",
    ...
    content:
      "I chose Zeefit to reverse my PCOD symptoms and lose weight. Previous trainer experiences were disappointing, but Zeefit showed immense promise. Taking a leap of faith, I embarked on this journey, and it turned out to be the best decision I made. With Zeefit's extensive knowledge and dedication, I overcame PCOD and adopted a preventive lifestyle. The unique training strategies and unwavering support have been invaluable. No more PCOS relapse for sure. Zeefit has transformed my life, and it can do the same for you.",
  },
  {
    id: 10,
    name: "DEEPAK K VIG",
    ...
    content:
      "Zeefit surpassed my expectations as a fitness platform. The patience and in-depth knowledge from my expert addressed all my workout and nutrition queries like no one else could—even before I signed up. Zeefit truly understands each individual's uniqueness and crafts precise diet and workout plans that are easy to follow. Previously, I had given up on my dream of achieving a good physique due to trainers who couldn't keep me motivated beyond 10 days. But with Zeefit, I'm confident that my dream will become a reality. It's been 6 months, and I couldn't be happier and more satisfied. In fact, my whole family uses Zeefit now. It is a complete package and truly amazing. I highly recommend Zeefit to everyone. It's the real deal!",
  },
];
