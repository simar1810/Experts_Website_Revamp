...
export const secondaryHeroContent = {
  headlineBefore: "With Great Fitness Goals... Comes The",
  headlineAfter: "Need For A Coach Who Won't Let You Quit",
  subheadline:
...
export const precisionContent = {
  id: "precision",
  title: "You have tried apps, gyms, and random advice. Now try the right expert",
  subtitle:
...
export const clientResultsContent = {
  ...
  badge: "100+ CLIENTS TRANSFORMED THEMSELVES WITH ZEEFIT",
